...
Fill Book Appointment Form From Dashboard
    ...
    Run Keyword If    '${Doctor}' != '' and '${Doctor}' != 'Select'
    ...    Select Doctor
    ...    ${Doctor}

    Run Keyword If    '${AppointmentType}' != '' and '${AppointmentType}' != 'Select'
    ...    Select Appointment Type
    ...    ${AppointmentType}

    Run Keyword If    '${StartTime}' != '' and '${StartTime}' != 'Select'
    ...    Select Start Time
    ...    ${StartTime}
    ...
    IF    '${ExpectedAlert}' == 'Record added successfully'
